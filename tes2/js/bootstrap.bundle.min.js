...
!(function (t, e) {
      ...
      : Ft(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              "rtl" === bt(s || i).direction && (a += Lt(i.clientWidth, s ? s.clientWidth : 0) - o),
  ...
  function se(t, e, i) {
    ...
    return (
      (a || (!a && !i)) &&
        (("body" !== lt(e) || Ut(o)) &&
          (l = (n = e) !== ct(n) && ht(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : qt(n)),
  ...
  class we extends R {
    ...
    show() {
      ...
      if (!H.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
        ...
        "ontouchstart" in document.documentElement &&
          ...
          [].concat(...document.body.children).forEach((t) => H.on(t, "mouseover", p)),
          this._element.focus(),
    ...
    _completeHide(t) {
      H.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          [].concat(...document.body.children).forEach((t) => H.off(t, "mouseover", p)),
  ...
  class De {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Ce, ...("object" == typeof t ? t : {}) }).rootElement = t.rootElement || document.body),
        d("backdrop", t, xe),
        t
      );
    }
  ...
  class Me extends R {
    ...
    _getConfig(t) {
      return (
        (t = { ...je, ...U.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }),
        d("offcanvas", t, Pe),
        t
      );
    }
    ...
    show() {
      ...
      w.set(s, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (l.appendChild(s), H.trigger(this._element, this.constructor.Event.INSERTED)),
    ...
    _initializeOnDelegatedTarget(t, e) {
      ...
      return (
        (e = e || w.get(t.delegateTarget, i)) ||
          ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), w.set(t.delegateTarget, i, e)),
        e
      );
    }
    _getOffset() {
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        ...
        if (
          ...
          (e || ((e = new Je(this, i)), w.set(this, "bs.popover", e)), "string" == typeof t)
        ) {
          if (void 0 === e[t]) throw new TypeError(`No method named "${t}"`);
          e[t]();
        }
  ...
  class ii extends R {
    ...
    _getConfig(t) {
      if (
        "string" !=
          typeof (t = { ...ti, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) })
            .target &&
        a(t.target)
      ) {
        let { id: i } = t.target;
  ...
  class ri extends R {
    ...
    _getConfig(t) {
      return (
        (t = { ...oi, ...U.getDataAttributes(this._element), ...("object" == typeof t && t ? t : {}) }),
